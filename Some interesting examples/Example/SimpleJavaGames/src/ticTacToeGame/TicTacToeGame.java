...
//Module awt using for actions
import java.awt.*;
import java.awt.event.*;//awt events here we have objects to check what hepend
import java.awt.geom.*;//to drow lines
//Module for GUI
import javax.swing.*;
//...
import java.util.*;
...
public class TicTacToeGame extends JFrame {
    ...
    class Field {
        ...
        boolean isWin(char ch){
            //checking horizonttals/verticals
            for(int i=0; i<FIELD_SIZE; i++){
